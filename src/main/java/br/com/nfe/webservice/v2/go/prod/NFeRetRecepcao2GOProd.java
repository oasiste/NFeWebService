...
import br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferetrecepcao2.NfeCabecMsg;
import br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferetrecepcao2.NfeDadosMsg;
import br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferetrecepcao2.NfeRetRecepcao2;
import br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferetrecepcao2.NfeRetRecepcao2Locator;
import br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferetrecepcao2.NfeRetRecepcao2Result;

public class NFeRetRecepcao2GOProd extends NFeRetRecepcao2 {
	...
	public NFeRetRecepcao2GOProd(String xmlRetRecepcao) {
		super();
