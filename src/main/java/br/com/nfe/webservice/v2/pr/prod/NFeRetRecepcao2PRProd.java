...
import br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nferetrecepcao2.NfeDadosMsg;
import br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nferetrecepcao2.NfeRetRecepcao2;
import br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nferetrecepcao2.NfeRetRecepcao2Locator;
import br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nferetrecepcao2.NfeRetRecepcao2Result;
import br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nferetrecepcao2.NfeRetRecepcao2Soap12Stub;

public class NFeRetRecepcao2PRProd extends NFeRetRecepcao2 {
	
	private String xmlRetRecepcao;
	
	public NFeRetRecepcao2PRProd(String xmlRetRecepcao) {
