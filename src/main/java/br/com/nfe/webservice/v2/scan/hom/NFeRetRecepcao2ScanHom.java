...
import br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeRecepcao2.NfeCabecMsg;
import br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeRetRecepcao2.NfeDadosMsg;
import br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeRetRecepcao2.NfeRetRecepcao2;
import br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeRetRecepcao2.NfeRetRecepcao2Locator;
import br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeRetRecepcao2.NfeRetRecepcao2Result;
import br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeRetRecepcao2.NfeRetRecepcao2Soap12Stub;

public class NFeRetRecepcao2ScanHom extends NFeRetRecepcao2 {
	
	private String xmlRetRecepcao;
	
	public NFeRetRecepcao2ScanHom(String xmlRetRecepcao) {
