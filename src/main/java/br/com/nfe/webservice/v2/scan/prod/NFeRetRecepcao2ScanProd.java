...
import br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeRecepcao2.NfeCabecMsg;
import br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeRetRecepcao2.NfeDadosMsg;
import br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeRetRecepcao2.NfeRetRecepcao2;
import br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeRetRecepcao2.NfeRetRecepcao2Locator;
import br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeRetRecepcao2.NfeRetRecepcao2Result;
import br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeRetRecepcao2.NfeRetRecepcao2Soap12Stub;

public class NFeRetRecepcao2ScanProd extends NFeRetRecepcao2 {
	
	private String xmlRetRecepcao;
	
	public NFeRetRecepcao2ScanProd(String xmlRetRecepcao) {
	...
	public void envia() throws ServiceException, SAXException, IOException, ParserConfigurationException, XmlException {
		NfeRetRecepcao2 nfeRetRecepcaoScan = new NfeRetRecepcao2Locator();
		...
		NfeRetRecepcao2Soap12Stub nfeRetRecepcao2Soap12Stub = (NfeRetRecepcao2Soap12Stub) nfeRetRecepcaoScan.getNfeRetRecepcao2Soap();
