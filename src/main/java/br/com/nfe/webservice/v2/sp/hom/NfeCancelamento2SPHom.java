...
import br.inf.portalfiscal.www.nfe.wsdl.sp.hom.NfeCancelamento2.NfeCabecMsg;
import br.inf.portalfiscal.www.nfe.wsdl.sp.hom.NfeCancelamento2.NfeCancelamento2;
import br.inf.portalfiscal.www.nfe.wsdl.sp.hom.NfeCancelamento2.NfeCancelamento2Locator;
import br.inf.portalfiscal.www.nfe.wsdl.sp.hom.NfeCancelamento2.NfeCancelamento2Soap12Stub;
import br.inf.portalfiscal.www.nfe.wsdl.sp.hom.NfeCancelamento2.NfeCancelamentoNF2Result;
import br.inf.portalfiscal.www.nfe.wsdl.sp.hom.NfeCancelamento2.NfeDadosMsg;

public class NfeCancelamento2SPHom extends NFeCancelamento2 {

	private String xmlCancelamento;

	public NfeCancelamento2SPHom(String xmlCancelamento) {
	...
	public void envia() throws ServiceException, SAXException, IOException, ParserConfigurationException, XmlException {
		...
		NfeCancelamento2 nfeCancelamentoSP = new NfeCancelamento2Locator();

		((NfeCancelamento2Soap12Stub) nfeCancelamentoSP.getNfeCancelamento2Soap12()).setHeader(oHeaderElement);
		...
		NfeCancelamentoNF2Result lote2Result = nfeCancelamentoSP.getNfeCancelamento2Soap12().nfeCancelamentoNF2(dadosMsg);
