...
import br.inf.portalfiscal.www.nfe.wsdl.sp.prod.nfecancelamento2.NfeCabecMsg;
import br.inf.portalfiscal.www.nfe.wsdl.sp.prod.nfecancelamento2.NfeCancelamento2;
import br.inf.portalfiscal.www.nfe.wsdl.sp.prod.nfecancelamento2.NfeCancelamento2Locator;
import br.inf.portalfiscal.www.nfe.wsdl.sp.prod.nfecancelamento2.NfeCancelamento2Soap12Stub;
import br.inf.portalfiscal.www.nfe.wsdl.sp.prod.nfecancelamento2.NfeCancelamentoNF2Result;
import br.inf.portalfiscal.www.nfe.wsdl.sp.prod.nfecancelamento2.NfeDadosMsg;

public class NfeCancelamento2SPProd extends NFeCancelamento2 {

	private String xmlCancelamento;
	
	public NfeCancelamento2SPProd(String xmlCancelamento) {
	...
	public void envia() throws ServiceException, SAXException, IOException, ParserConfigurationException, XmlException {
		...
		NfeCancelamento2Soap12Stub nfeCancelamento2Soap12Stub = (NfeCancelamento2Soap12Stub) nfeCancelamentoSP.getNfeCancelamento2Soap12();
