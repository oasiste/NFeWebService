...
public class NfeCancelamento2Locator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.go.hom.nfecancelamento2.NfeCancelamento2 {
    ...
    private java.lang.String NfeCancelamentoServicePort_address = "https://homolog.sefaz.go.gov.br/nfe/services/v2/NfeCancelamento2";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.go.hom.nfecancelamento2.NfeCancelamentoService getNfeCancelamentoServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.go.hom.nfecancelamento2.NfeCancelamentoService getNfeCancelamentoServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.go.hom.nfecancelamento2.NfeCancelamentoServiceBindingStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.go.hom.nfecancelamento2.NfeCancelamentoServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.go.hom.nfecancelamento2.NfeCancelamentoService.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.go.hom.nfecancelamento2.NfeCancelamentoServiceBindingStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.go.hom.nfecancelamento2.NfeCancelamentoServiceBindingStub(new java.net.URL(NfeCancelamentoServicePort_address), this);
                _stub.setPortName(getNfeCancelamentoServicePortWSDDServiceName());
                return _stub;
            }
        }
