...
public class NfeRetRecepcao2Locator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.go.hom.nferetrecepcao2.NfeRetRecepcao2 {
    ...
    private java.lang.String NfeRetRecepcaoServicePort_address = "https://homolog.sefaz.go.gov.br/nfe/services/v2/NfeRetRecepcao2";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.go.hom.nferetrecepcao2.NfeRetRecepcaoService getNfeRetRecepcaoServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.go.hom.nferetrecepcao2.NfeRetRecepcaoService getNfeRetRecepcaoServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.go.hom.nferetrecepcao2.NfeRetRecepcaoServiceBindingStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.go.hom.nferetrecepcao2.NfeRetRecepcaoServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.go.hom.nferetrecepcao2.NfeRetRecepcaoService.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.go.hom.nferetrecepcao2.NfeRetRecepcaoServiceBindingStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.go.hom.nferetrecepcao2.NfeRetRecepcaoServiceBindingStub(new java.net.URL(NfeRetRecepcaoServicePort_address), this);
                _stub.setPortName(getNfeRetRecepcaoServicePortWSDDServiceName());
                return _stub;
            }
        }
