...
public class NfeRecepcao2Locator extends org.apache.axis.client.Service implements NfeRecepcao2 {
    ...
    private java.lang.String NfeRecepcaoServicePort_address = "https://nfe.sefaz.go.gov.br/nfe/services/v2/NfeRecepcao2";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferecepcao2.NfeRecepcaoService getNfeRecepcaoServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferecepcao2.NfeRecepcaoService getNfeRecepcaoServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferecepcao2.NfeRecepcaoServiceBindingStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferecepcao2.NfeRecepcaoServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferecepcao2.NfeRecepcaoService.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferecepcao2.NfeRecepcaoServiceBindingStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.go.prod.nferecepcao2.NfeRecepcaoServiceBindingStub(new java.net.URL(NfeRecepcaoServicePort_address), this);
                _stub.setPortName(getNfeRecepcaoServicePortWSDDServiceName());
                return _stub;
            }
        }
