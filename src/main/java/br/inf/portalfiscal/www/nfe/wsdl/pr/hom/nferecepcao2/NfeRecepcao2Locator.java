...
public class NfeRecepcao2Locator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferecepcao2.NfeRecepcao2 {
 ...
 */
    ...
    //private java.lang.String NfeRecepcaoServicePort_address = "https://200.189.113.250:8543/nfe/NFeRecepcao2";
    private java.lang.String NfeRecepcaoServicePort_address = "https://homologacao.nfe2.fazenda.pr.gov.br/nfe/NFeRecepcao2";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferecepcao2.NfeRecepcao2Soap12 getNfeRecepcaoServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferecepcao2.NfeRecepcao2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferecepcao2.NfeRecepcao2Soap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferecepcao2.NfeRecepcao2Soap12.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferecepcao2.NfeRecepcao2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferecepcao2.NfeRecepcao2Soap12Stub(new java.net.URL(NfeRecepcaoServicePort_address), this);
                _stub.setPortName(getNfeRecepcaoServicePortWSDDServiceName());
                return _stub;
            }
        }
