...
public class NfeRetRecepcao2Locator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferetrecepcao2.NfeRetRecepcao2 {
 ...
 */
    ...
    private java.lang.String NfeRetRecepcaoServicePort_address = "https://homologacao.nfe2.fazenda.pr.gov.br/nfe/NFeRetRecepcao2";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferetrecepcao2.NfeRetRecepcao2Soap12 getNfeRetRecepcaoServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferetrecepcao2.NfeRetRecepcao2Soap12 getNfeRetRecepcaoServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferetrecepcao2.NfeRetRecepcao2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferetrecepcao2.NfeRetRecepcao2Soap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferetrecepcao2.NfeRetRecepcao2Soap12.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferetrecepcao2.NfeRetRecepcao2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.pr.hom.nferetrecepcao2.NfeRetRecepcao2Soap12Stub(new java.net.URL(NfeRetRecepcaoServicePort_address), this);
                _stub.setPortName(getNfeRetRecepcaoServicePortWSDDServiceName());
                return _stub;
            }
        }
