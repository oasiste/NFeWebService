...
public class NfeCancelamento2Locator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nfecancelamento2.NfeCancelamento2 {
 ...
 */
    ...
    private java.lang.String NfeCancelamentoServicePort_address =  "https://nfe2.fazenda.pr.gov.br/nfe/NFeCancelamento2";//  "https://ssefa00013.fazenda.pr.gov.br:8543/nfe/NFeCancelamento2";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nfecancelamento2.NfeCancelamento2Soap12 getNfeCancelamentoServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nfecancelamento2.NfeCancelamento2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nfecancelamento2.NfeCancelamento2Soap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nfecancelamento2.NfeCancelamento2Soap12.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nfecancelamento2.NfeCancelamento2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.pr.prod.nfecancelamento2.NfeCancelamento2Soap12Stub(new java.net.URL(NfeCancelamentoServicePort_address), this);
                _stub.setPortName(getNfeCancelamentoServicePortWSDDServiceName());
                return _stub;
            }
        }
