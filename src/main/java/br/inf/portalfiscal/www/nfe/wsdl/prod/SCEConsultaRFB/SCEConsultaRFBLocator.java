...
public class SCEConsultaRFBLocator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFB {
    ...
    private java.lang.String SCEConsultaRFBSoap_address = "https://www.nfe.fazenda.gov.br/SCEConsultaRFB/SCEConsultaRFB.asmx";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap getSCEConsultaRFBSoap() throws javax.xml.rpc.ServiceException {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap getSCEConsultaRFBSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoapStub(portAddress, this);
    ...
    private java.lang.String SCEConsultaRFBSoap12_address = "https://www.nfe.fazenda.gov.br/SCEConsultaRFB/SCEConsultaRFB.asmx";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap getSCEConsultaRFBSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap getSCEConsultaRFBSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoapStub(new java.net.URL(SCEConsultaRFBSoap_address), this);
                _stub.setPortName(getSCEConsultaRFBSoapWSDDServiceName());
                return _stub;
            }
            if (br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.prod.SCEConsultaRFB.SCEConsultaRFBSoap12Stub(new java.net.URL(SCEConsultaRFBSoap12_address), this);
                _stub.setPortName(getSCEConsultaRFBSoap12WSDDServiceName());
                return _stub;
            }
        }
