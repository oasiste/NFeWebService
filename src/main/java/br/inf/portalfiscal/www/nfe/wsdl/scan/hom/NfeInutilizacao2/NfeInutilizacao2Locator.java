...
public class NfeInutilizacao2Locator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2 {
    ...
    private java.lang.String NfeInutilizacao2Soap12_address = "https://hom.nfe.fazenda.gov.br/SCAN/NfeInutilizacao2/NfeInutilizacao2.asmx";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap getNfeInutilizacao2Soap12() throws javax.xml.rpc.ServiceException {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap getNfeInutilizacao2Soap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap12Stub(portAddress, this);
    ...
    private java.lang.String NfeInutilizacao2Soap_address = "https://hom.nfe.fazenda.gov.br/SCAN/NfeInutilizacao2/NfeInutilizacao2.asmx";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap getNfeInutilizacao2Soap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap getNfeInutilizacao2Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2SoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap12Stub(new java.net.URL(NfeInutilizacao2Soap12_address), this);
                _stub.setPortName(getNfeInutilizacao2Soap12WSDDServiceName());
                return _stub;
            }
            if (br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2SoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.scan.hom.NfeInutilizacao2.NfeInutilizacao2SoapStub(new java.net.URL(NfeInutilizacao2Soap_address), this);
                _stub.setPortName(getNfeInutilizacao2SoapWSDDServiceName());
                return _stub;
            }
        }
