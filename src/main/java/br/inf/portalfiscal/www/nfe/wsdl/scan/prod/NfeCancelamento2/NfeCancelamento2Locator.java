...
public class NfeCancelamento2Locator extends org.apache.axis.client.Service implements br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2 {
    ...
    private java.lang.String NfeCancelamento2Soap12_address = "https://www.scan.fazenda.gov.br/NfeCancelamento2/NfeCancelamento2.asmx";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap getNfeCancelamento2Soap12() throws javax.xml.rpc.ServiceException {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap getNfeCancelamento2Soap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap12Stub(portAddress, this);
    ...
    private java.lang.String NfeCancelamento2Soap_address = "https://www.scan.fazenda.gov.br/NfeCancelamento2/NfeCancelamento2.asmx";
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap getNfeCancelamento2Soap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap getNfeCancelamento2Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2SoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap12Stub _stub = new br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap12Stub(new java.net.URL(NfeCancelamento2Soap12_address), this);
                _stub.setPortName(getNfeCancelamento2Soap12WSDDServiceName());
                return _stub;
            }
            if (br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2SoapStub _stub = new br.inf.portalfiscal.www.nfe.wsdl.scan.prod.NfeCancelamento2.NfeCancelamento2SoapStub(new java.net.URL(NfeCancelamento2Soap_address), this);
                _stub.setPortName(getNfeCancelamento2SoapWSDDServiceName());
                return _stub;
            }
        }
